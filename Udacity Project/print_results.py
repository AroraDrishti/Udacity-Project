...
def print_results(res_dic, res_stt_dic, mod, print_inc_dogs=False, print_inc_breed=False):
    ...
    print('No. of Images: {} No. of Dog Images: {} No. of not Dog Images: {}'.format(res_stt_dic['n_images'], res_stt_dic['n_dogs_img'], res_stt_dic['n_notdogs_img']))
    ...
    if print_inc_dogs == True and (res_stt_dic['n_correct_dogs'] + res_stt_dic['n_correct_notdogs'] != res_stt_dic['n_images']):
        for key in res_dic:
    ...
    if print_inc_breed == True and (res_stt_dic['n_correct_dogs'] != res_stt_dic['n_correct_breed']):
        for key in res_dic:   
